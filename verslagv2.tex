...
\dfrac
{
	\langle Dv, GET\llbracket (var, \mathcal{O}) \rrbracket_o \rangle \rightarrow var\prime
	\quad
	\langle  GET\llbracket (x_i, \mathcal{I}) \rrbracket_{var}, var\prime[this \mapsto var] \rangle
	\rightarrow
	var\prime\prime
}
{
	...
	\rightarrow
	o[var \mapsto GET\llbracket (this, \mathcal{O}) \rrbracket_{var\prime\prime}]
}\\
[DvSkip_{ns}] &
