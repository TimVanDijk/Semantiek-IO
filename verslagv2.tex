...
%TODO: kijk hier nog even goed naar.
\begin{abstract}
...
\end{lstlisting}
%Als we het voorbeeld houden zoals het hierboven staat dan moeten we assignment toevoegen.
...
%Wilde we M niet wegdoen?
%Klopt de FROM regel en klopt die me het voorbeeld? Moet er niet nog een WITH bij ofzo
\begin{lstlisting}
