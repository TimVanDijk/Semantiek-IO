...
| CLONE var_p AS var_c | FROM var CALL x_i Dv | SET var_o SLOT x TO i
\end{lstlisting}
...
$
\begin{matrix}
[clone_{ns}] & <CLONE \enspace var_p \enspace AS \enspace var_c, o, l> \rightarrow <o\prime, l\prime> \\ 
\end{matrix}
$
\begin{align*}
	waar: \\
