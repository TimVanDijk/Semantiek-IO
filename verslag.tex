...
De syntax van Io is relatief eenvoudig en beperkt, en bevat weinig gereserveerde termen zoals gebruikelijk in andere talen. Termen als 'if', 'while' en 'for' zijn bijvoorbeeld in veel talen gereserveerde termen, maar niet in Io. Wel gelijk aan de meeste talen is dat een programma simpelweg een opeenvolging van expressies is. We defineeren eerst een individuele expressie:
...
%todo: Volgens de regels zouden we nu ook, net als in While, vat moeten leggen wat een identifier, number of string nou eigenlijk inhoud.
